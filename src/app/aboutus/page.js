  ...
  return (
    <div className="bg-gray-100">
      <div className="min-h-screen py-16 px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid sm:grid-cols-2 grid-cols-1 bg-white mx-auto px-4 py-10 rounded-3xl text-center">
          <div className="text-center flex flex-col justify-center ml-5">
            ...
            <p className="text-gray-600 text-lg text-bold text-justify">
              We aim to provide outstanding value to the business community by enabling companies to achieve
              exceptional human resource efficiency and nurturing students to become exemplary professionals, ready to lead the future workforce.
            </p>
          </div>
