          ...
          {internships && internships.length > 0 ? (
            <ul className="space-y-6">
              {internships.map((internship) => (
                <div key={internship._id} className="sm:mx-24 mx-2 p-6 bg-white rounded-lg shadow-md hover:shadow-2xl transition-shadow duration-300">
                  <li className="mb-2">
                  ...
                  <p><span className="font-bold">Title:</span> {internship.title}</p>
                    ...
                    <p>
                      <span className="font-bold">Company Website URL : </span> 
                      <a href={internship.c_url} target="_blank" rel="noopener noreferrer" className="text-purple-500 hover:underline ml-1 break-all whitespace-normal">
                        {internship.c_url}
                      </a>
                    </p>
                  </div>
