...
async function AdminHome(){
  ...
  return (
    <div className="h-screen w-full mb-64">
      ...
      <div className="h-24 w-24 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-full shadow-lg mt-6 mb-3"></div>
        ...
        <div className="grid grid-cols-2 gap-6">
          ...
          <div className="h-48 w-72 bg-[#a080e1] border rounded-bl-lg cursor-pointer hover:bg-pink-600 transform hover:scale-105 transition duration-300">
          ...
          <div className="h-48 w-72 bg-[#5c509c] border rounded-br-lg cursor-pointer hover:bg-pink-700 transform hover:scale-105 transition duration-300">
