...
export async function POST(request) {
  try {
    const {  company_title, title, location, description, url, eligibilityCriteria } = await request.json();
    await connectDb();
    await Internships.create({ company_title, title, location, description, url, eligibilityCriteria });
